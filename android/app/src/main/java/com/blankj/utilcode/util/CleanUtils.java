...
public final class CleanUtils {
    ...
    public static boolean cleanInternalCache() {
        return deleteFilesInDir(com.blankj.utilcode.util.Utils.getApp().getCacheDir());
    }
    ...
    public static boolean cleanInternalFiles() {
        return deleteFilesInDir(com.blankj.utilcode.util.Utils.getApp().getFilesDir());
    }
    ...
    public static boolean cleanInternalDbs() {
        return deleteFilesInDir(new File(com.blankj.utilcode.util.Utils.getApp().getFilesDir().getParent(), "databases"));
    }
    ...
    public static boolean cleanInternalSp() {
        return deleteFilesInDir(new File(com.blankj.utilcode.util.Utils.getApp().getFilesDir().getParent(), "shared_prefs"));
    }

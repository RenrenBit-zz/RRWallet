...
public final class UriUtils {
    ...
    /**
     * @deprecated Use {@link com.blankj.utilcode.util.UriUtils#file2Uri(File)} instead.
     */
    @Deprecated
    ...
    public static Uri file2Uri(final File file) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            String authority = com.blankj.utilcode.util.Utils.getApp().getPackageName() + ".utilcode.provider";

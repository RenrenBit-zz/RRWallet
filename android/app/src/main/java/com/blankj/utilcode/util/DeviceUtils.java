...
public final class DeviceUtils {
    ...
    private static String getMacAddressByWifiInfo() {
        try {
            Context context = com.blankj.utilcode.util.Utils.getApp().getApplicationContext();
    ...
    public static void shutdown() {
        ...
        com.blankj.utilcode.util.Utils.getApp().startActivity(intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
    }

...
public final class SizeUtils {
    ...
    public static int dp2px(final float dpValue) {
        final float scale = com.blankj.utilcode.util.Utils.getApp().getResources().getDisplayMetrics().density;
    ...
    public static int sp2px(final float spValue) {
        final float fontScale = com.blankj.utilcode.util.Utils.getApp().getResources().getDisplayMetrics().scaledDensity;

...
public final class ReflectUtils {
     ...
     * @return the single {@link com.blankj.utilcode.util.ReflectUtils} instance
     * @throws ReflectException if reflect unsuccessfully
     */
    public static com.blankj.utilcode.util.ReflectUtils reflect(final String className)
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public static com.blankj.utilcode.util.ReflectUtils reflect(final String className, final ClassLoader classLoader)
            throws ReflectException {
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public static com.blankj.utilcode.util.ReflectUtils reflect(final Class<?> clazz)
            throws ReflectException {
        return new com.blankj.utilcode.util.ReflectUtils(clazz);
    }
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public static com.blankj.utilcode.util.ReflectUtils reflect(final Object object)
            throws ReflectException {
        return new com.blankj.utilcode.util.ReflectUtils(object == null ? Object.class : object.getClass(), object);
    }
     ...
     * @return the single {@link com.blankj.utilcode.util.ReflectUtils} instance
     */
    public com.blankj.utilcode.util.ReflectUtils newInstance(Object... args) {
    ...
    private com.blankj.utilcode.util.ReflectUtils newInstance(final Constructor<?> constructor, final Object... args) {
        try {
            return new com.blankj.utilcode.util.ReflectUtils(
     ...
     * @return the single {@link com.blankj.utilcode.util.ReflectUtils} instance
     */
    public com.blankj.utilcode.util.ReflectUtils field(final String name) {
        try {
            Field field = getField(name);
            return new com.blankj.utilcode.util.ReflectUtils(field.getType(), field.get(object));
     ...
     * @return the single {@link com.blankj.utilcode.util.ReflectUtils} instance
     */
    public com.blankj.utilcode.util.ReflectUtils field(String name, Object value) {
        try {
            Field field = getField(name);
    ...
    private Object unwrap(Object object) {
        if (object instanceof com.blankj.utilcode.util.ReflectUtils) {
            return ((com.blankj.utilcode.util.ReflectUtils) object).get();
        }
        return object;
    }
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public com.blankj.utilcode.util.ReflectUtils method(final String name) throws ReflectException {
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public com.blankj.utilcode.util.ReflectUtils method(final String name, final Object... args) throws ReflectException {
        Class<?>[] types = getArgsType(args);
        try {
    ...
    private com.blankj.utilcode.util.ReflectUtils method(final Method method, final Object obj, final Object... args) {
        try {
            accessible(method);
    ...
    public boolean equals(Object obj) {
        return obj instanceof com.blankj.utilcode.util.ReflectUtils && object.equals(((com.blankj.utilcode.util.ReflectUtils) obj).get());
    }

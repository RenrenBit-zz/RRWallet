...
public final class ActivityUtils {
    ...
    public static boolean isActivityExists(@NonNull final String pkg,
        ...
        return !(com.blankj.utilcode.util.Utils.getApp().getPackageManager().resolveActivity(intent, 0) == null ||
                intent.resolveActivity(com.blankj.utilcode.util.Utils.getApp().getPackageManager()) == null ||
                com.blankj.utilcode.util.Utils.getApp().getPackageManager().queryIntentActivities(intent, 0).size() == 0);
    }
    ...
    public static void startActivity(@NonNull final Class<? extends Activity> clz) {
        Context context = com.blankj.utilcode.util.Utils.getTopActivityOrApp();
    ...
    public static void startActivity(@NonNull final String pkg,
                                     @NonNull final String cls) {
        startActivity(com.blankj.utilcode.util.Utils.getTopActivityOrApp(), null, pkg, cls, null);
    }
    ...
    public static void startActivity(@NonNull final String pkg,
                                     @NonNull final String cls,
                                     final Bundle options) {
        startActivity(com.blankj.utilcode.util.Utils.getTopActivityOrApp(), null, pkg, cls, options);
    }
    ...
    public static void startActivity(@NonNull final Bundle extras,
                                     @NonNull final String pkg,
                                     @NonNull final String cls) {
        startActivity(com.blankj.utilcode.util.Utils.getTopActivityOrApp(), extras, pkg, cls, null);
    }
    ...
    public static void startActivity(@NonNull final Bundle extras,
                                     ...
                                     @NonNull final String cls,
                                     final Bundle options) {
        startActivity(com.blankj.utilcode.util.Utils.getTopActivityOrApp(), extras, pkg, cls, options);
    }
    ...
    public static void startActivity(@NonNull final Intent intent) {
        startActivity(intent, com.blankj.utilcode.util.Utils.getTopActivityOrApp(), null);
    }
    ...
    public static void startActivity(@NonNull final Intent intent,
                                     @NonNull final Bundle options) {
        startActivity(intent, com.blankj.utilcode.util.Utils.getTopActivityOrApp(), options);
    }
    ...
    public static void startActivities(@NonNull final Intent[] intents) {
        startActivities(intents, com.blankj.utilcode.util.Utils.getTopActivityOrApp(), null);
    }
    ...
    public static void startActivities(@NonNull final Intent[] intents,
                                       final Bundle options) {
        startActivities(intents, com.blankj.utilcode.util.Utils.getTopActivityOrApp(), options);
    }
    ...
    public static List<Activity> getActivityList() {
        return com.blankj.utilcode.util.Utils.getActivityList();
    }
    ...
    public static Activity getTopActivity() {
        return com.blankj.utilcode.util.Utils.getActivityLifecycle().getTopActivity();
    }
    ...
    public static boolean isActivityExistsInStack(@NonNull final Activity activity) {
        List<Activity> activities = com.blankj.utilcode.util.Utils.getActivityList();
    ...
    public static void finishAllActivities(final boolean isLoadAnim) {
        List<Activity> activityList = com.blankj.utilcode.util.Utils.getActivityList();

...
public final class SnackbarUtils {
     ...
     * @return the single {@link com.blankj.utilcode.util.SnackbarUtils} instance
     */
    public static com.blankj.utilcode.util.SnackbarUtils with(@NonNull final View view) {
        return new com.blankj.utilcode.util.SnackbarUtils(view);
    }
     ...
     * @return the single {@link com.blankj.utilcode.util.SnackbarUtils} instance
     */
    public com.blankj.utilcode.util.SnackbarUtils setMessage(@NonNull final CharSequence msg) {
        this.message = msg;
        return this;
    }
     ...
     * @return the single {@link com.blankj.utilcode.util.SnackbarUtils} instance
     */
    public com.blankj.utilcode.util.SnackbarUtils setMessageColor(@ColorInt final int color) {
     ...
     * @return the single {@link com.blankj.utilcode.util.SnackbarUtils} instance
     */
    public com.blankj.utilcode.util.SnackbarUtils setBgColor(@ColorInt final int color) {
        this.bgColor = color;
        return this;
    }
     ...
     * @return the single {@link com.blankj.utilcode.util.SnackbarUtils} instance
     */
    public com.blankj.utilcode.util.SnackbarUtils setBgResource(@DrawableRes final int bgResource) {
     ...
     * @return the single {@link com.blankj.utilcode.util.SnackbarUtils} instance
     */
    public com.blankj.utilcode.util.SnackbarUtils setDuration(@Duration final int duration) {
     ...
     * @return the single {@link com.blankj.utilcode.util.SnackbarUtils} instance
     */
    public com.blankj.utilcode.util.SnackbarUtils setAction(@NonNull final CharSequence text,
     ...
     */
    public com.blankj.utilcode.util.SnackbarUtils setBottomMargin(@IntRange(from = 1) final int bottomMargin) {

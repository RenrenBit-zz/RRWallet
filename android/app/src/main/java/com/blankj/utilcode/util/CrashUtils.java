...
public final class CrashUtils {
    ...
    static {
        try {
            PackageInfo pi = com.blankj.utilcode.util.Utils.getApp()
                    .getPackageManager()
                    .getPackageInfo(com.blankj.utilcode.util.Utils.getApp().getPackageName(), 0);
            if (pi != null) {
    ...
    public static void init(final String crashDirPath, final OnCrashListener onCrashListener) {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                && com.blankj.utilcode.util.Utils.getApp().getExternalCacheDir() != null)
            defaultDir = com.blankj.utilcode.util.Utils.getApp().getExternalCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        else {

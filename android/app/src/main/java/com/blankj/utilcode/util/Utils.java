...
public final class Utils {
    ...
    public static void init(@NonNull final Application app) {
        if (sApplication == null) {
            com.blankj.utilcode.util.Utils.sApplication = app;
            com.blankj.utilcode.util.Utils.sApplication.registerActivityLifecycleCallbacks(ACTIVITY_LIFECYCLE);
        }
    }
    ...
    static boolean isAppForeground() {
        ...
        for (ActivityManager.RunningAppProcessInfo aInfo : info) {
            if (aInfo.importance == ActivityManager.RunningAppProcessInfo.IMPORTANCE_FOREGROUND) {
                return aInfo.processName.equals(com.blankj.utilcode.util.Utils.getApp().getPackageName());
            }
        }
        return false;
    }
